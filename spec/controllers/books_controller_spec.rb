...
RSpec.describe Api::V1::BooksController, type: :controller do
  describe "GET index" do
    it "has max limit of 100" do
      expect(Book).to receive(:limit).with(described_class::MAX_PAGINATION_LIMIT).and_call_original
  ...
  describe "POST create" do
    ...
    context "authorization header present"  do
      ...
      it "calls UpdateSkuJob with correct params" do
        ...
        post :create, params: { author: { first_name: "ReactJS", last_name: "Author" }, book: { title: book_title } }
      end
    end
